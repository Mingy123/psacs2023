<script setup>
  ...
  import travelHistory from "../files/my-trips.json";
  import ports from "../files/psaports.json";
  ...
  function initGlobe() {
    ...
    setTimeout(() => {
      Globe.arcsData(travelHistory.trips)
        .arcColor((e) => {
